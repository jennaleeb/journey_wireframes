...
// ************************* DEBUG ONLY ********************************************
// Measuring activity for DEBUGGING, shows graph whilst measuring accelerometer data
public class DebugMeasureActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnStart = (Button)findViewById(R.id.debug_button_start);
        mBtnStart.setOnClickListener(this);
        mBtnStop = (Button)findViewById(R.id.debug_button_stop);
        mBtnStop.setOnClickListener(this);
        mBtnProcess = (Button)findViewById(R.id.debug_button_process);
        ...
        mGraph = (LineChart)findViewById(R.id.debug_graph);
        setupGraph();
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.debug_button_start:
                mGraph.clear();
                setupGraph();
                startCollecting();
                break;
            case R.id.debug_button_stop:
                stopCollecting();
                break;
            case R.id.debug_button_process:
                startProcessing();
                break;
        }
    }
