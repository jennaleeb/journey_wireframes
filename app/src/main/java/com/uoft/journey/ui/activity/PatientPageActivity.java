...
public class PatientPageActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PatientProfileFragment(), "Profile");
        adapter.addFragment(new PatientNewsfeedFragment(), "Chart");
        adapter.addFragment(new PatientHistoryFragment(), "Trends");
